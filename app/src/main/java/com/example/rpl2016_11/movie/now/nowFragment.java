package com.example.rpl2016_11.movie.now;
...
public class nowFragment extends Fragment {
    ...
    SwipeRefreshLayout mSwipeRefreshLayout, swipe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_now, container, false);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i <jsonArray.length(); i++){
                        ...
                        Log.d("gendon", "onResponse: "+tittle);
                    }
